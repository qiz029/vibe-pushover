...
```sh
curl -fsSL https://github.com/qiz029/vibe-pushover/releases/download/v0.11.0/install.sh | \
  VIBE_PUSHOVER_VERSION=v0.11.0 VIBE_PUSHOVER_INSTALL_DIR="$HOME/bin" sh
```
